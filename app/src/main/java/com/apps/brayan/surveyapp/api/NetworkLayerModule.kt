...
class NetworkLayerModule{
    @Provides
    fun provideRepository(firebaseDatabase: FirebaseDatabase,firebaseAuth: FirebaseAuth,context:MasterApp): SurveyRepository{
        return SurveyRepository(firebaseDatabase,firebaseAuth,context)
    }
}